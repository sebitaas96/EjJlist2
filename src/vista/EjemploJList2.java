...
public class EjemploJList2 extends JFrame {
	...
	public EjemploJList2() {
		...
		DefaultListModel<Ciudad> modelo= new DefaultListModel<Ciudad>();
		modelo.addAll(listaCiudades);
		//modelo.addElement("Ana");
		modelo.addElement(new Ciudad(4,"Roma"));
		...
		btnNewButton3.addActionListener(e->{
			JOptionPane.showMessageDialog(null, ((Ciudad)listaConModelo.getSelectedValue()).getNombreCiudad());
